...
/* ---- Detail Lowongan ---- */
window.lihatLowongan = function(id, posisi, kategori, gaji, deadline, tanggung, kualifikasi) {
    ...
    if (detailDeadline) detailDeadline.innerText = deadline || 'Tidak ada batas waktu';
...
window.editLowonganLangsung = function(id, posisi, kategori, gaji, deadline, tanggung, kualifikasi) {
    activeJob = { id, posisi, kategori, gaji, deadline, tanggung, kualifikasi };
    bukaEdit();
}
