...
<div id="modal-overlay"
    ...
    {{-- Kotak pop-up utama --}}
    <div id="modal-box"
         class="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl mx-4 md:mx-0
...
--}}
<div id="detail-modal" class="fixed inset-0 z-[2000] bg-black/50 backdrop-blur-sm hidden items-center justify-center p-4">
...
--}}
<div id="hapus-modal" class="fixed inset-0 z-[5000] bg-black/50 backdrop-blur-sm hidden items-center justify-center p-4">
