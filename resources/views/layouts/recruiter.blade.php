...
<head>
    ...
    <style>
        ...
        .sidebar-active { font-weight: 700; color: #1B3A5C; border-left: 4px solid #1B3A5C; background: transparent; }
        .sidebar-inactive { font-weight: 500; color: #6B7280; }
        .sidebar-inactive:hover { color: #1B3A5C; background: rgba(27,58,92,0.05); }
        .progress-bar { height: 6px; border-radius: 999px; background: #E5EAE7; overflow: hidden; }
        .progress-bar-fill { height: 100%; border-radius: 999px; background: #1B3A5C; }
    </style>
    <script>
        ...
        <div>
            ...
            <div class="px-6 py-8 flex items-center">
                <a href="{{ url('/') }}" class="block">
                    <img src="{{ asset('images/logodesign.png') }}" alt="Bursa Tenaga Kerja Logo" class="w-40 h-auto object-contain">
                </a>
            </div>
