    ...
    <div class="space-y-6 lg:space-y-8">
        ...
        <div class="relative w-full rounded-3xl overflow-hidden shadow-sm flex-shrink-0 min-w-0 min-h-[160px]">
            ...
            @if($company->banner_path)
                <img src="{{ asset('storage/' . $company->banner_path) }}" class="absolute inset-0 w-full h-full object-cover"
            ...
            <div class="absolute inset-0 p-4 md:p-6 flex items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-5 flex-1 min-w-0">
                    ...
                    <!-- Kotak Logo Putih -->
                    <div
                        class="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-2xl flex items-center justify-center p-2.5 shadow-lg border border-white/20 flex-shrink-0">
                    ...
                    <div class="space-y-1 flex-1 min-w-0">
                        <h2 id="profileCompanyName" class="text-3xl sm:text-4xl text-white drop-shadow-md truncate"
                            style="font-family: 'Super Wonder', sans-serif;">{{ $company->name ?: 'Nama Perusahaan Anda' }}
                        </h2>
                        <p
                            class="text-sm font-semibold text-slate-200 drop-shadow truncate md:whitespace-normal line-clamp-2">
                            {{ $company->description ?: 'Belum ada deskripsi singkat perusahaan.' }}</p>
                    </div>
                ...
                <div class="flex justify-end gap-3 flex-wrap flex-shrink-0">
                    <a href="#"
                        class="flex items-center gap-2 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white font-extrabold text-xs py-2.5 px-4 rounded-xl border border-white/30 transition-all shadow-sm">
                    ...
                    <a href="{{ route('company.profile.edit') }}"
                        class="flex items-center gap-2 bg-[#143E72] hover:bg-[#0c2c54] text-white font-extrabold text-xs py-2.5 px-5 rounded-xl transition-all shadow-md">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-[24px] p-6 sm:p-8 shadow-sm border border-[#F3EFE0] flex flex-col h-fit">
                        <svg class="w-8 h-8 text-[#113255] mb-5" viewBox="0 0 24 24" fill="currentColor">
                            <path
                                d="M19 15L17.5 18.5L14 20L17.5 21.5L19 25L20.5 21.5L24 20L20.5 18.5L19 15ZM10 1L7 8L0 11L7 14L10 21L13 14L20 11L13 8L10 1ZM10 15.1L8.7 12.3L5.9 11L8.7 9.7L10 6.9L11.3 9.7L14.1 11L11.3 12.3L10 15.1Z" />
                        </svg>
                ...
                <div class="flex flex-col gap-4 mt-2">
                    <h3 class="text-[22px] font-extrabold text-[#113255] tracking-tight">Gallery Di <span
                            id="galleryCompanyName">{{ $company->name ?: 'Perusahaan' }}</span></h3>
                    ...
                    @else
                        ...
                        <div
                            class="w-full h-[256px] rounded-[24px] border-2 border-dashed border-slate-300 bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-slate-100 hover:border-[#143E72] hover:text-[#143E72] transition-colors cursor-pointer group">
                            <div class="flex flex-col items-center gap-3">
                                <svg class="w-8 h-8 opacity-70 group-hover:opacity-100 transition-opacity" fill="none"
            ...
            <div class="lg:col-span-1 flex flex-col gap-6">
                ...
                <div class="bg-white rounded-[24px] p-6 sm:p-8 shadow-sm flex flex-col h-fit">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 rounded-xl bg-[#E6F2FE] flex items-center justify-center flex-shrink-0 text-[#143E72]">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Skala
                                    Karyawan</p>
                                <p class="text-[14px] font-extrabold text-slate-800">{{ $company->size ?: 'Belum diisi' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Kantor Pusat
                                </p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                @if($company->website)
                                    <a href="{{ str_starts_with($company->website, 'http') ? $company->website : 'https://' . $company->website }}"
                                        target="_blank"
                                        class="text-[14px] font-extrabold text-[#387CD9] hover:text-[#143E72] transition-colors">{{ $company->website }}</a>
                                @else
                ...
                <!-- HIRING PERKS -->
                <div
                    class="bg-kuning-renyah rounded-[24px] p-6 sm:p-8 shadow-sm border border-[#F3EFE0] flex flex-col flex-1">
                        ...
                        @forelse($company->perks as $perk)
                            <li class="flex items-start gap-3">
                                <div class="mt-0.5 bg-white rounded-full p-1 shadow-sm border border-slate-100 flex-shrink-0">
                                    <svg class="w-3.5 h-3.5 text-emerald-500" fill="none" stroke="currentColor" stroke-width="4"
                                        viewBox="0 0 24 24">
